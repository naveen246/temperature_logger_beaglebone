...
chmod u+x /home/root/temp_logger/temp_logger_init.sh
cp /home/root/temp_logger/temp_logger_init.service /lib/systemd/
...
cp /home/root/temp_logger/usb_automount.rules /etc/udev/rules.d/
